...
{
	char* str1;
	strcpy_s(str1, strlen(this->str), str);
	strcpy_s(this->str, strlen(this->str), str);
}
...
int main()
{
    ...
    /*my_string str2 = str;*/
    /*f(str);*/
    my_string strd = "Hello world";
    my_string str_cpy = strd;
    my_string strf = f(strd);
    size_t lenght = strd.length();
    char att = strd.at(pos);
 /*   size_t lenght = str.swap();*/
